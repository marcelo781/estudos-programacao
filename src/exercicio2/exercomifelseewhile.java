...
public class exercomifelseewhile {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// Programa que pede 2 números, realiza uma operação aritmética entre eles e retorna o resultado, se é maior, menor ou igual a zero e se é par ou impar.
		...
		System.out.println("Escolha uma opção aritmética: 1 para soma, 2 para subtracao, 3 para divisão e 4 para multiplicacao");
